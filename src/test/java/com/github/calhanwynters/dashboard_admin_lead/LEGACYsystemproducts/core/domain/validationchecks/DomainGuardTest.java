package com.github.calhanwynters.dashboard_admin_lead.LEGACYsystemproducts.core.domain.validationchecks;
...
import com.github.calhanwynters.dashboard_admin_lead.LEGACYsystemproducts.core.domain.common.exceptions.DomainRuleViolationException;
...
class DomainGuardTest {
    ...
    class StringTests {
        ...
        void matches_shouldValidateAgainstPattern() {
            ...
            // 2. Failure Case: Handle the Optional and the correct field featuresName (violatedRule)
    ...
    class NumberTests {
        ...
        void bigDecimal_shouldValidateNonNegativeAndPositive() {
            ...
            assertThatThrownBy(() -> DomainGuard.positive(BigDecimal.ZERO, "price"))
                    ...
                    .satisfies(ex -> {
                        DomainRuleViolationException dre = (DomainRuleViolationException) ex;
                        // Assert against the Optional return types and correct property featuresName
        ...
        void longPositive_shouldValidateOverload() {
            ...
            assertThatThrownBy(() -> DomainGuard.positive(0L, "stockCount"))
                    ...
                    .satisfies(ex -> {
                        DomainRuleViolationException dre = (DomainRuleViolationException) ex;
                        // Verify the Optional values and the correct property featuresName
        ...
        void noNullElements_shouldWorkWithSets() {
            ...
            assertThatThrownBy(() -> DomainGuard.noNullElements(setWithNull, "permissions"))
                    ...
                    .satisfies(ex -> {
                        ...
                        assertThat(dre.getErrorCode()).contains("VAL-012");
                        // Asserting against the correct property featuresName in your Exception class
                        assertThat(dre.getViolatedRule()).contains("COLLECTION_INTEGRITY");
                    });
        }
    }
