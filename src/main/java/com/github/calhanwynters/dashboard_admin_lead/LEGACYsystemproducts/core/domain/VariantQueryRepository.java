...
/**
 * CQRS Read-Side Repository for Variant.
 * Optimized for state retrieval in 2026 clean architecture standards.
 */
public interface VariantQueryRepository {
     ...
     * Maps to the size() method in your VariantBehavior.
     */
    int countFeaturesInCollection(UuId variantId);
}
