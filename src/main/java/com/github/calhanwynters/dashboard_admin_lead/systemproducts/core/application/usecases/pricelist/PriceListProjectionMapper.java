...
import com.github.calhanwynters.dashboard_admin_lead.systemproducts.core.application.usecases.pricelist.PriceListProjectionDTO.*;
...
public class PriceListProjectionMapper {
    ...
    public static PriceListProjectionDTO toDTO(PriceListAggregate aggregate) {
        ...
        return new PriceListProjectionDTO(
                ...
                "Standard Price List", // Default name for 2026 snapshot
