...
/**
 * Handler for soft-deleting a Feature.
 * Orchestrates security checks and state transition via BaseAggregateRoot.
 */
@Service
public class FeatureSoftDeleteHandler {

    private final FeaturesRepository repository;

    public FeatureSoftDeleteHandler(FeaturesRepository repository) {
    ...
    public FeatureDTO handle(UUID uuid, FeatureSoftDTO dto) {
        ...
        // This triggers ensureActive(), verifyLifecycleAuthority(), and records the event
