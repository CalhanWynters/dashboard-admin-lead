...
public class PriceListFactory {
     ...
     */
    public static PriceList createNew(UuId businessId, Class<? extends PurchasePricing> boundary) {
     ...
     */
    public static PriceList reconstitute(
            PkId id,
            UuId uuId,
            UuId businessId,
        ...
        return new PriceList(id, uuId, businessId, boundary, version, audit, prices);
    }
}
