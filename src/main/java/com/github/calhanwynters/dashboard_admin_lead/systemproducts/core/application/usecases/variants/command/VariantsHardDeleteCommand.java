...
/**
 * Command for the permanent removal of a Variant.
 * Critical for SOC 2 Data Disposal compliance and auditability.
 */
public record VariantsHardDeleteCommand(
        UUID targetUuId,
        String actorId,
     ...
     */
    public static VariantsHardDeleteCommand of(UUID targetUuId, String actorId, Set<String> actorRoles) {
        ...
        return new VariantsHardDeleteCommand(targetUuId, actorId, actorRoles != null ? actorRoles : Set.of());
    }
